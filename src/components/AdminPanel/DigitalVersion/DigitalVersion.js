          ...
          <div className="flex items-center justify-between">
            <div className=" relative ">
              <input
                ...
                type="text"
                onChange={(event)=>{productdata.format = event.target.value}}
              />
            ...
            <div className=" relative ">
              <input
                className="w-[270px] h-10 border-solid border-gmain border-1 p-1 rounded-lg bg-gmelo 	"
                type="text"
                onChange={(event)=>{productdata.numberPageDigital = event.target.value}}
              />
          ...
          <div className="flex items-center justify-between">
            <div className=" relative">
              <input
                className="w-[270px] h-10 border-solid border-gmain border-1 p-1 rounded-lg bg-gmelo 	"
                type="text"
                onChange={(event)=>{productdata.volume = event.target.value}}
              />
            ...
            <div className="flex gap-3">
              ...
              <div className="file 	">
                ...
                <input ref={inputRef} onChange={(event)=>{productdata.fileDigital = event.target.files[0]}} className="hidden" type="file" id="upload-file" />
              </div>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <div className=" relative">
              <input
                className="w-[270px] h-10 border-solid border-gmain border-1 p-1 rounded-lg bg-gmelo 	"
                type="text"
                onChange={(event)=>{productdata.priceDigital = event.target.value}}
              />
