            ...
            <div className="flex items-center justify-between">
              <div className=" relative">
                <input
                  ...
                  type="text"
                  onChange={(event) =>{productdata.speaker = event.target.value}}
                />
              ...
              <div className=" relative">
                <input
                  className="w-[270px] h-10 border-solid border-gmain border-1 p-1 rounded-lg bg-gmelo 	"
                  type="text"
                  onChange={(event) =>{productdata.publishAudio = event.target.value}}
                />
                <p className="bg-gmelo text-text absolute -top-4 right-2">
                انتشارات صوتی
                </p>
            ...
            <div className="flex items-center justify-between">
              <div className=" relative">
                <input
                  className="w-[270px] h-10 border-solid border-gmain border-1 p-1 rounded-lg bg-gmelo 	"
                  type="text"
                  onChange={(event) =>{productdata.priceAudio = event.target.value}}
                />
                <p className="bg-gmelo text-text absolute -top-4 right-2">
                قیمت
                </p>
              ...
              <div className="file 	">
                <label onClick={handelLabaleClick}>
                  <span>
                    <img
                ...
                <input ref={inputRef} onChange={(event) =>{productdata.fileAudio = event.target.files[0]}} className="hidden" type="file" id="upload-file" />
              </div>
              </div>
            </div>
