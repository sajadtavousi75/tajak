            ...
            <div className="footer-content flex-col">
                <div className="footer-content__top py-4 flex items-center justify-between ">
                    <div className='flex flex-col'>
                        ...
                        <Link to='/about' className='text-text text-sm	font-bold border-solid border-gmain border-y-2 rounded-lg p-2 mt-2'>پرسش های متداول</Link>
                    </div>
                ...
                <div className="footer-content__botton flex flex-col md:flex-row items-center justify-between py-4">
                    ...
                    <div className=''>
                        <div className="suport flex flex-col w-[300px] lg:flex-row items-center justify-between">
